...
import ibdb.src.view.BookCountsInStoresView;

public class BookCountsInStoresServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;
		private BookCountsInStores entr;
		private String msg;

		public void init() throws ServletException {
			entr = new BookCountsInStores();
		...
		public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
			...
			if (!msg.startsWith("Servus")) {
			    out.println("<h1>Database connection failed to open " + msg + "</h1>");
					...
					BookCountsInStoresView.setWriter(out);
                                        String written = "vgvbhlj";
                                        written = request.getParameter("bookStoreName"); 
					BookCountsInStoresView.printBookCountsInStoresPage(written, entr);
			}
